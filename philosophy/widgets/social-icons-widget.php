...
class philosophy_SocialIcons_Widget extends WP_Widget {
...
} // class philosophy_SocialIcons_Widget

function philosophy_widget_register() {
    register_widget( 'philosophy_SocialIcons_Widget' );
}

add_action( 'widgets_init', 'philosophy_widget_register' );
