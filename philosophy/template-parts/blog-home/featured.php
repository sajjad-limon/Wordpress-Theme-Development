...
/* custom field name featured_post , meta key - featured */
    ...
    <div class="col-full">
        ...
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[0] ["thumbnail"] ); ?>');">
                    ...
                    <div class="entry__content">
                        <span class="entry__category"><a href="<?php echo esc_url( $post_data[0] ['cat_link'] ); ?> ">
                            <?php echo esc_html( $post_data[0] ["cat"] ); ?> </a>
                        </span>
            ...
            <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[$i] ["thumbnail"] ); ?>');">
                    ...
                    <div class="entry__content">
                        <span class="entry__category"><a href="<?php echo esc_url( $post_data[$i] ["cat_link"] ); ?>">
                            <?php echo esc_html( $post_data[$i] ["cat"] ); ?> </a>
                        </span>
